...
const magician = ["Tom", "Marie", "Annie"];
show_magician(magician);
//Question-42
let magicianNames = ["Tom", "Marie", "Annie"];
function show_the_magicians(greet) {
...
function showTheMagicians(greet) {
    let withGreetings = "";
...
const myCar = createCar('mercedes', 'corolla', { color: "silver", year: 2020 });
console.log(myCar);
